...
export const lastUpdated = "April 2, 2026";
export const whatsNew = [
  ...
  "Google TurboQuant algorithm (Mar 25): 6x memory reduction, 8x speed increase for AI inference at zero accuracy loss — presented at ICLR 2026",
  "OpenAI discontinuing Sora video tool (Mar 24): app shutdown Apr 26, API Sep 24; strategic pivot to coding and enterprise products",
  "OpenAI closed record $122B funding round at $852B valuation (Mar 31); GPT-5.4 mini/nano launched Mar 17 for high-volume workloads",
  "LSEG-Microsoft MCP expansion (Mar 31): LSEG data now in M365 Copilot (Teams, Excel); 33 petabytes accessible via MCP connectors",
];
