...
export const lastUpdated = "April 1, 2026";
export const whatsNew = [
  ...
  "Anthropic Claude Mythos model revealed via data leak (Mar 26) — new tier above Opus, described as 'step change' in capabilities",
  "Thomson Reuters + Smokeball partnership (Mar 25): CoCounsel Legal AI integrated with practice management for small/mid-size firms",
  "MSCI IndexAI Insights launched (Feb 25): AI connectors for ChatGPT and Claude providing conversational access to MSCI index data",
];
